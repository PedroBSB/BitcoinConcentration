...
library(lubridate)
library(fPortfolio)
json <- getURL('https://poloniex.com/public?command=returnChartData&currencyPair=USDT_BTC&start=1435699200&end=9999999999&period=14400'); BTC <- fromJSON(json); BTC <- do.call(rbind.data.frame, BTC); BTC$date<-anytime(BTC$date); BTC$hour3 <- lubridate::floor_date(BTC$date , '3 hours')
